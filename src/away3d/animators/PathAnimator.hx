package away3d.animators;
	...
	class PathAnimator extends EventDispatcher
	{
		...
		var _lookAtTarget:Object3D;
		var _offset:Vector3D;
		var _tmpOffset:Vector3D;
		var _position:Vector3D = new Vector3D();
		var _lastTime:Float;
		var _from:Float;
		var _to:Float;
		var _bRange:Bool;
		var _bSegment:Bool;
		var _bCycle:Bool;
		var _lastSegment:UInt = 0;
		var _rot:Vector3D;
		var _upAxis:Vector3D = new Vector3D(0, 1, 0);
		var _basePosition:Vector3D = new Vector3D(0, 0, 0);
		 ...
		 */
		function PathAnimator(path:IPath = null, target:Object3D = null, offset:Vector3D = null, alignToPath:Bool = true, lookAtTarget:Object3D = null, rotations:Array<Vector3D> = null)
		{
			_index = 0;
			_time = _lastTime = 0;
		 ...
		 * @see Path
		 */
		public function set_path(value:IPath) : Void
		{
			_path = value;
		}
		 ...
		 */
		public function set_target(object3d:Object3D) : Void
		{
			_target = object3d;
		}
		
		public var target(get, set) : Void;
		 ...
		 */
		public function set_lookAtObject(object3d:Object3D) : Void
		{
		...
		public var lookAtObject(get, set) : Void;
		
		public function get_lookAtObject() : Void
		{
		 ...
		 */
		public var rotations(null, set) : Void;
		public function set_rotations(value:Array<Vector3D>) : Void
		{
			_rotations = value;
		 ...
		 */
		public function set_index(val:UInt) : Void
		{
		 ...
		 */
		public function addOnCycle(listener:xxx->yyy):Void
		{
			_lastTime = 0;
			_bCycle = true;
		 ...
		 * @param        listener        The listener function
		 */
		public function removeOnCycle(listener:xxx->yyy):Void
		{
			_bCycle = false;
		...
		public function addOnRange(listener:xxx->yyy, from:Float = 0, to:Float = 0):Void
		{
			_from = from;
			_to = to;
			_bRange = true;
		 ...
		 * @param        listener        The listener function
		 */
		public function removeOnRange(listener:xxx->yyy):Void
		{
			_from = 0;
			_to = 0;
			_bRange = false;
		 ...
		 * @param        listener        The listener function
		 */
		public function addOnChangeSegment(listener:xxx->yyy):Void
		{
			_bSegment = true;
			_lastSegment = 0;
		 ...
		 * @param        listener        The listener function
		 */
		public function removeOnChangeSegment(listener:xxx->yyy):Void
		{
			_bSegment = false;
			_lastSegment = 0;
