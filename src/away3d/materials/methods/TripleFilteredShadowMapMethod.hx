...
@:meta(Deprecated(message = "Please consider any of the superior shadow map methods: SoftShadowMapMethod or DitheredShadowMapMethod"))
...
/**
    ...
    public function new(castingLight:DirectionalLight) {
        super(castingLight);
        if (Std.is(castingLight, PointLight)) throw new Error("FilteredShadowMapMethod not supported for Point Lights");
    }
