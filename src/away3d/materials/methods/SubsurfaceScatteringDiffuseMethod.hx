package away3d.materials.methods;
	...
	{
		var _depthPass:SingleObjectDepthPass;
		var _lightProjVarying:ShaderRegisterElement;
		var _propReg:ShaderRegisterElement;
		var _scattering:Float;
		var _translucency:Float = 1;
		var _lightColorReg:ShaderRegisterElement;
		var _scatterColor:UInt = 0xffffff;
		var _colorReg:ShaderRegisterElement;
		var _decReg:ShaderRegisterElement;
		var _scatterR:Float = 1.0;
		var _scatterG:Float = 1.0;
		var _scatterB:Float = 1.0;
		var _targetReg:ShaderRegisterElement;
		...
		override public function initConstants(vo:MethodVO):Void
		{
			...
			var data:Array<Float> = vo.vertexData;
		...
		public function get_scatterColor() : UInt
		{
			return _scatterColor;
		}
		
		public function set_scatterColor(scatterColor:UInt) : UInt
		{
		 ...
		 * @inheritDoc
		 */
		override function getFragmentCodePerLight(vo:MethodVO, lightDirReg:ShaderRegisterElement, lightColReg:ShaderRegisterElement, regCache:ShaderRegisterCache):String
		{
			_isFirstLight = true;
