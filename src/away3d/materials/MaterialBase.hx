package away3d.materials;
	...
	class MaterialBase extends NamedAssetBase implements IAsset
	{
		 ...
		 * @private
		 */
		/*arcane*/ public var _classification:String;
		 ...
		 * @private
		 */
		/*arcane*/ public var _uniqueId:UInt;
		 ...
		 * @private
		 */
		/*arcane*/ public var _renderOrderId:Int;
		 ...
		 * @private
		 */
		/*arcane*/ public var _depthPassId:Int;
		 ...
		 */
		var _owners:Array<IMaterialOwner>;
		...
		var _distancePass:DistanceMapPass;
		
		var _lightPicker:LightPickerBase;
		var _distanceBasedDepthRender:Bool;
		var _depthCompareMode:Int;
		 ...
		 */
		public var depthCompareMode(get, set) : UInt;
		public function get_depthCompareMode() : UInt
		{
			return _depthCompareMode;
		}
		
		public function set_depthCompareMode(value:UInt) : UInt
		{
		...
		public function dispose():Void
		{
			...
			// For loop conversion - 						for (i = 0; i < _numPasses; ++i)
		...
		public function get_uniqueId() : UInt
		{
			return _uniqueId;
		}
		...
		public function get_numPasses() : UInt
		{
			return _numPasses;
		}
		 ...
		 * @private
		 */
		public var owners(get, null) : Array<IMaterialOwner>;
		public function get_owners() : Array<IMaterialOwner>
		{
			return _owners;
		}
		...
		{
			_passes.splice(Lambda.indexOf(_passes, pass), 1);
			--_numPasses;
		}
		...
		private function clearPasses():Void
		{
			...
			_passes = new Array<MaterialPassBase>();//.length = 0;
			_numPasses = 0;
		}
		...
		private function onPassChange(event:Event):Void
		{
			...
			for (i in 0..._numPasses) {
				...
				len = ids.length;
				// For loop conversion - 				for (var j:Int = 0; j < len; ++j)
				var j:Int = 0;
				//for (j in 0...len) {
				//	if (ids[j] != -1) {
		...
		{
			var ids:Array<Int> = _distancePass._program3Dids;
		...
		{
			var ids:Array<Int> = _depthPass._program3Dids;
			var len:UInt = ids.length;
