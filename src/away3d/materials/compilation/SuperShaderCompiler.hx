package away3d.materials.compilation;
	...
	class SuperShaderCompiler extends ShaderCompiler
	{
		...
		{
			var normalMatrix:Array<ShaderRegisterElement> = ArrayUtils.Prefill(new Array<ShaderRegisterElement>(), 3, null);
		...
		private function compileDirectionalLightCode():Void
		{
			...
			// For loop conversion - 						for (var i:UInt = 0; i < _numDirectionalLights; ++i)
		...
		private function compilePointLightCode():Void
		{
			...
			// For loop conversion - 						for (var i:UInt = 0; i < _numPointLights; ++i)
		...
		private function compileLightProbeCode():Void
		{
			...
			// For loop conversion - 						for (i = 0; i < _numProbeRegisters; ++i)
