package away3d.materials.passes;
	...
	{
		var _fragmentData:Array<Float>;
		var _vertexData:Array<Float>;
		var _alphaThreshold:Float;
		...
		{
			super();
			_fragmentData = [    1.0, 255.0, 65025.0, 16581375.0,
		...
		override function render(renderable:IRenderable, stage3DProxy:Stage3DProxy, camera:Camera3D, viewProjection:Matrix3D):Void
		{
			...
			context.setProgramConstantsFromMatrix(Context3DProgramType.VERTEX, 5, sceneTransform.flashMatrix3D, true);
