package away3d.core.pick;
	...
	class RaycastPicker implements IPicker
	{
		...
		var _raycastCollector:RaycastCollector;
		var _ignoredEntities:Array<Dynamic>;
		...
		public function getEntityCollision(position:Vector3D, direction:Vector3D, entities:Array<Entity>):PickingCollisionVO
		{
			...
			Lambda.foreach(entities, function(entity:Entity):Bool {
		...
		private function isIgnored(entity:Entity):Bool
		{
			...
			Lambda.foreach(_ignoredEntities, function(ignoredEntity:Entity):Bool {
		...
		private function getPickingCollisionVO():PickingCollisionVO
		{
			...
			// For loop conversion - 						for (i = 0; i < _numEntities; ++i)
