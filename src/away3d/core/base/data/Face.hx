...
/**
    ...
    public function clone():Face {
        var nVertices:Vector<Float> = Vector.ofArray(cast [_vertices[0], _vertices[1], _vertices[2], _vertices[3], _vertices[4], _vertices[5], _vertices[6], _vertices[7], _vertices[8]]);
        var nUvs:Vector<Float> = Vector.ofArray(cast [_uvs[0], _uvs[1], _uvs[2], _uvs[3], _uvs[4], _uvs[5]]);
