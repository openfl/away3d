package away3d.core.render;
	...
	class DefaultRenderer extends RendererBase
	{
		...
		var _distanceRenderer:DepthRenderer;
		var _depthRenderer:DepthRenderer;
		var _skyboxProjection:Matrix3D;
		...
		override function set_stage3DProxy(value:Stage3DProxy) : Stage3DProxy
		{
		...
		private override function executeRender(entityCollector:EntityCollector, target:TextureBase = null, scissorRect:Rectangle = null, surfaceSelector:Int = 0):Void
		{
