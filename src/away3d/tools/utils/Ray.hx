package away3d.tools.utils;
	...
	class Ray
	{
		 ...
		 */
		public function set_orig(o:Vector3D) : Void
		{
			_orig.x = o.x;
			_orig.y = o.y;
			_orig.z = o.z;
		...
		public var orig(get, set) : Void;
		
		public function get_orig() : Void
		{
			return _orig;
		}
		 ...
		 */
		public function set_dir(n:Vector3D) : Void
		{
			_dir.x = n.x;
			_dir.y = n.y;
			_dir.z = n.z;
		...
		public var dir(get, set) : Void;
		
		public function get_dir() : Void
		{
			return _dir;
		}
		 ...
		 */
		public var planeNormal(get, null) : Vector3D;
		...
		public function getRayToSphereIntersection(pOrig:Vector3D, dir:Vector3D, sPos:Vector3D, radius:Float, bNearest:Bool = true, bNormal:Bool = false, outVector3D:Vector3D = null):Vector3D
		{
			...
			//todo, add dist return. var dist:Float = Math.sqrt(a)*t;
