package away3d.tools.utils;
	...
	class Drag3D
	{
		...
		var _view:View3D;
		var _debug:Bool;
		var _object3d:ObjectContainer3D;
		var _planeXZ:Mesh;
		var _planeXY:Mesh;
		var _planeZY:Mesh;
		var _red:ColorMaterial;
		var _green:ColorMaterial;
		var _blue:ColorMaterial;
		var _planesContainer:ObjectContainer3D;
		
		var _np:Vector3D = new Vector3D(0.0, 0.0, 0.0);
		var _intersect:Vector3D = new Vector3D(0.0, 0.0, 0.0);
		var _rotations:Vector3D;
		var _baserotations:Vector3D;
		var _offsetCenter:Vector3D = new Vector3D(0.0, 0.0, 0.0);
		var _bSetOffset:Bool;
		...
		var _planeid:String;
		var _useRotations:Bool;
		
		// TODO: not used
		// var _inverse:Matrix3D = new Matrix3D();
		 ...
		 */
		public function set_useRotations(b:Bool) : Void
		{
			_useRotations = b;
		...
		public var useRotations(get, set) : Void;
		
		public function get_useRotations() : Void
		{
		 ...
		 * prior to drag.
		 */
		public function set_offsetCenter(b:Bool) : Void
		{
			if (b && !_object3d)
		...
		public var offsetCenter(get, set) : Void;
		
		public function get_offsetCenter() : Void
		{
			return _bSetOffset;
		}
		 ...
		 */
		public function set_debug(b:Bool) : Void
		{
			_debug = b;
		 ...
		 */
		public var plane(null, set) : Void;
		public function set_plane(planeid:String) : Void
		{
		 ...
		 */
		public var planeObject3d(null, set) : Void;
		public function set_planeObject3d(object3d:ObjectContainer3D) : Void
		{
		 ...
		 */
		public var planePosition(null, set) : Void;
		public function set_planePosition(pos:Vector3D) : Void
		{
			switch (_planeid) {
				//XZ
				case PLANE_XZ:
