...
// Loop over all triangles
            ...
            while (i < len) {
                ...
                while (j < 3) {
                    ...
                    if (mappings[originalIndex] >= 0) splitIndex = mappings[originalIndex]
                    else {
...
// More was added in the last iteration of the loop.
        ...
        else subs.push(constructSubGeometry(verts, indices, uvs, normals, tangents, weights, jointIndices, triangleOffset));
        return subs;
    }
