package away3d.paths;
	...
	class QuadraticPath extends SegmentedPathBase implements IPath
	{
		...
		public function get_smoothed() : Bool
		{
			return _smoothed;
		}
		...
		public function get_averaged() : Bool
		{
			return _averaged;
		}
		...
		public function smoothPath():Void
		{
			...
			// For loop conversion - 						for (i = 0; i < numSegments - 1; ++i)
			...
			// For loop conversion - 						for (i = 0; i < tmp.length; i += 3)
		...
		public function averagePath():Void
		{
			...
			// For loop conversion - 						for (var i:UInt = 0; i < _segments.length; ++i)
		...
		public function continuousCurve(points:Array<Vector3D>, closed:Bool = false):Void
		{
			...
			// For loop conversion - 			for (i = 0; i < points.length - 1; i++)
			...
			// For loop conversion - 						for (i = 0; i < aVectors.length; i += 3)
			
			for (i in 0...aVectors.length)
