package away3d.stereo;
	...
	{
		var _leftTexture:Texture;
		var _rightTexture:Texture;
		
		var _rttManager:RTTBufferManager;
		var _program3D:Program3D;
		
		var _method:StereoRenderMethodBase;
		
		var _program3DInvalid:Bool = true;
		var _leftTextureInvalid:Bool = true;
		var _rightTextureInvalid:Bool = true;
