package away3d.events;
	...
	class MouseEvent3D extends Event
	{
		...
		/*arcane*/ public var _parentEvent:MouseEvent3D;
		 ...
		 */
		//		public static var ROLL_OVER : String = "rollOver3d";
		
		/**
		 * Defines the value of the type property of a rollOut3d event object.
		 */
		//		public static var ROLL_OUT : String = "rollOut3d";
		...
		public function get_bubbles() : Bool
		{
			...
			_allowedToPropagate = true;// Don't bubble if propagation has been stopped.
			return doesBubble;
		}
		#else
		...
		public override function clone():Event
		{
			...
			// TODO: Is isDefaultPrevented supported in OpenFL
