...
/**
	 ...
	 */
    static public var APPEND_NUM_SUFFIX:ConflictStrategyBase = new NumSuffixConflictStrategy();
/**
	 ...
	 */
    static public var IGNORE:ConflictStrategyBase = new IgnoreConflictStrategy();
/**
	 ...
	 */
    static public var THROW_ERROR:ConflictStrategyBase = new ErrorConflictStrategy();
}
