...
/**
    ...
    override public function rayIntersection(position:Vector3D, direction:Vector3D, targetNormal:Vector3D):Float {
        ...
        var py:Float = position.y - _centerY;
        var pz:Float = position.z - _centerZ;
        var vx:Float = direction.x;
        var vy:Float = direction.y;
        var vz:Float = direction.z;
        var ix:Float;
        var iy:Float;
        var iz:Float;
...
/**
    ...
    override public function transformFrom(bounds:BoundingVolumeBase, matrix:Matrix3D):Void {
        ...
        var m12:Float = raw[4];
        var m13:Float = raw[8];
        var m14:Float = raw[12];
        var m21:Float = raw[1];
        var m22:Float = raw[5];
        var m23:Float = raw[9];
        var m24:Float = raw[13];
        var m31:Float = raw[2];
        var m32:Float = raw[6];
        var m33:Float = raw[10];
        var m34:Float = raw[14];
