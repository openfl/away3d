package away3d.cameras.lenses;
	...
	class LensBase extends EventDispatcher
	{
		...
		var _matrixInvalid:Bool;
		var _frustumCorners:Array<Float>;
		
		var _unprojection:Matrix3D;
		var _unprojectionInvalid:Bool;
		...
		public function new()
		{
			...
			_matrixInvalid = true;
			_frustumCorners = new Array<Float>();
		...
		public function get_unprojectionMatrix() : Matrix3D
		{
			if (_unprojectionInvalid) {
				if (_unprojection==null) _unprojection = new Matrix3D();
