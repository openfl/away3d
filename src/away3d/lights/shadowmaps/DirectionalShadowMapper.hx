package away3d.lights.shadowmaps;
	...
	{
		var _overallDepthCamera:Camera3D;
		var _localFrustum:Array<Float>;
		
		var _lightOffset:Float = 10000;
		var _matrix:Matrix3D;
		var _overallDepthLens:FreeMatrixLens;
		var _snap:Float = 64;
		...
		public function get_depthProjection() : Matrix3D
		{
		...
		private function updateProjectionFromFrustumCorners(viewCamera:Camera3D, corners:Array<Float>, matrix:Matrix3D):Void
		{
