package away3d.tools.helpers;
	...
	class MeshDebugger
	{
		...
		var _meshesData:Array<MeshDebugData> = new Array<MeshDebugData>();
		var _colorNormals:UInt = 0xFF3399;
		var _colorVertexNormals:UInt = 0x66CCFF;
		var _colorTangents:UInt = 0xFFCC00;
		var _lengthNormals:Float = 50;
		var _lengthTangents:Float = 50;
		var _lengthVertexNormals:Float = 50;
		var _dirty:Bool;
		 ...
		 */
		public function set_colorNormals(val:UInt) : Void
		{
			_colorNormals = val;
			invalidate();
		}
		
		public var colorNormals(get, set) : Void;
		
		public function get_colorNormals() : Void
		{
		 ...
		 */
		public function set_colorVertexNormals(val:UInt) : Void
		{
			_colorVertexNormals = val;
			invalidate();
		}
		
		public var colorVertexNormals(get, set) : Void;
		
		public function get_colorVertexNormals() : Void
		{
		 ...
		 */
		public function set_colorTangents(val:UInt) : Void
		{
			_colorTangents = val;
			invalidate();
		}
		
		public var colorTangents(get, set) : Void;
		
		public function get_colorTangents() : Void
		{
		 ...
		 */
		public function set_lengthVertexNormals(val:Float) : Void
		{
			val = val < 0? 1 : val;
		...
		public var lengthVertexNormals(get, set) : Void;
		
		public function get_lengthVertexNormals() : Void
		{
		 ...
		 */
		public function set_lengthNormals(val:Float) : Void
		{
			val = val < 0? 1 : val;
			_lengthNormals = val;
			invalidate();
		...
		public var lengthNormals(get, set) : Void;
		
		public function get_lengthNormals() : Void
		{
		 ...
		 */
		public function set_lengthTangents(val:Float) : Void
		{
			val = val < 0? 1 : val;
			_lengthTangents = val;
			invalidate();
		...
		public var lengthTangents(get, set) : Void;
		
		public function get_lengthTangents() : Void
		{
		...
		{
			// For loop conversion - 			for (var i:UInt = 0; i < _meshesData.length; ++i)
			var i:UInt = 0;
