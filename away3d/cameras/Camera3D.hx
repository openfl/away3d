package away3d.cameras;
	...
	{
		var _viewProjection:Matrix3D;
		var _viewProjectionDirty:Bool;
		var _lens:LensBase;
		var _frustumPlanes:Array<Plane3D>;
		var _frustumPlanesDirty:Bool;
		...
		public function new(lens:LensBase = null)
		{
			...
			_frustumPlanes = new Array<Plane3D>();
		 ...
		 *
		 */
		public var frustumPlanes(get, null) : Array<Plane3D>;
