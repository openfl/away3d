...
class Asset3DLibraryBundle extends EventDispatcher {
	...
	*/
	 ...
	 *
	 * @param me A multiton enforcer for the Asset3DLibraryBundle ensuring it cannnot be instanced.
	 */
    public function new() {
        super();
    ...
    public static function getInstance(key:String = 'default'):Asset3DLibraryBundle {
        ...
        if (!Asset3DLibrary._instances.exists(key))
            Asset3DLibrary._instances.set(key, new Asset3DLibraryBundle());

        return Asset3DLibrary._instances.get(key);
    }
	 ...
	 *
	 * @see a3d.library.assets.Asset3DType
	 */
	 ...
	 * @param dispose Defines whether the assets should also be disposed.
	 *
	 * @see a3d.library.Asset3DLibrary.removeAsset()
	 */
