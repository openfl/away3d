...
class Asset3DLibrary {
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.conflictStrategy
	*/
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.conflictPrecedence
	*/
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.createIterator()
	*/
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.load()
	 */
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.loadData()
	 */
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.getAsset()
	 */
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.addAsset()
	*/
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.removeAsset()
	*/
	 ...
	 * @param dispose Defines whether the assets should also be disposed.
	 *
	 * @see a3d.library.Asset3DLibraryBundle.removeAssetByName()
	*/
	 ...
	 * @param dispose Defines whether the assets should also be disposed.
	 *
	 * @see a3d.library.Asset3DLibraryBundle.removeAllAssets()
	*/
	 ...
	 *
	 * @see a3d.library.Asset3DLibraryBundle.removeNamespaceAssets()
	*/
	 ...
	 *
	 * @param se A singleton enforcer for the Asset3DLibrary ensuring it cannnot be instanced.
	 */
    public function new() {
    }
}