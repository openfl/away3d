...
class Trident extends Mesh {
    ...
    private function buildTrident(length:Float, showLetters:Bool):Void {
        ...
        var vectors:Array<Vector<Vector3D>> = new Array<Vector<Vector3D>>();
        var colors:Array<UInt> = Vector.ofArray(cast [0xFF0000, 0x00FF00, 0x0000FF]);
        ...
        vectors[0] = Vector.ofArray(cast [new Vector3D(0, 0, 0), new Vector3D(base, 0, 0)]);
        ...
        vectors[1] = Vector.ofArray(cast [new Vector3D(0, 0, 0), new Vector3D(0, base, 0)]);
        ...
        vectors[2] = Vector.ofArray(cast [new Vector3D(0, 0, 0), new Vector3D(0, 0, base)]);
...
//x
            vectors[3] = Vector.ofArray(cast [new Vector3D(length + scl2, scl1, 0), new Vector3D(length + scl3, -scl1, 0), new Vector3D(length + scl3, scl1, 0), new Vector3D(length + scl2, -scl1, 0)]);
//y
