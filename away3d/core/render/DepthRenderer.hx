...
class DepthRenderer extends RendererBase {
    ...
    public function renderCascades(entityCollector:EntityCollector, target:TextureBase, numCascades:Int, scissorRects:Array<Rectangle>, cameras:Array<Camera3D>):Void {
        ...
        if (_activeMaterial != null) _activeMaterial.deactivateForDepth(_stage3DProxy);
...
// do not use near and far planes
    ...
    override private function draw(entityCollector:EntityCollector, target:TextureBase):Void {
        ...
        if (_renderBlended) drawRenderables(entityCollector.blendedRenderableHead, entityCollector);
        if (_activeMaterial != null) _activeMaterial.deactivateForDepth(_stage3DProxy);
