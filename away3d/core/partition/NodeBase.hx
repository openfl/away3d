package away3d.core.partition;
	...
	class NodeBase
	{
		/*arcane*/ public var _parent:NodeBase;
		var _childNodes:Array<NodeBase>;
		var _numChildNodes:UInt;
		var _debugPrimitive:WireframePrimitiveBase;
		
		/*arcane*/ public var _numEntities:Int;
		/*arcane*/ public var _collectionMark:UInt;
		...
		public function set_showDebugBounds(value:Bool) : Bool
		{
			...
			// For loop conversion - 						for (var i:UInt = 0; i < _numChildNodes; ++i)
		 ...
		 */
		public var parent(get, null) : NodeBase;
		...
		public function removeNode(node:NodeBase):Void
		{
			...
			var index:UInt = Lambda.indexOf(_childNodes, node);
		...
		// private function get numEntities():Int
		// {
		// 	return _numEntities;
		// }
