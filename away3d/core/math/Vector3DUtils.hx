package away3d.core.math;
	...
	class Vector3DUtils
	{
		 ...
		 */
		public static getAngle(w:Vector3D, q:Vector3D):Float
		{
		 ...
		 */
		public static matrix2euler(m1:Matrix3D):Vector3D
		{
		...
		public static quaternion2euler(quarternion:Quaternion):Vector3D
		{
			var result:Vector3D = new Vector3D();
		 ...
		 */
		public static matrix2scale(m:Matrix3D):Vector3D
		{
			var result:Vector3D = new Vector3D();
			var raw:Array<Float> = Matrix3DUtils.RAW_DATA_CONTAINER;
			m.copyRawDataTo(raw);
		...
		public static subdivide(startVal:Vector3D, endVal:Vector3D, numSegments:Int):Array<Vector3D>
		{
