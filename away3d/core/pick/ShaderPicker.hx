package away3d.core.pick;
	...
	class ShaderPicker implements IPicker
	{
		...
		var _objectProgram3D:Program3D;
		var _triangleProgram3D:Program3D;
		var _bitmapData:BitmapData;
		var _viewportData:Array<Float>;
		var _boundOffsetScale:Array<Float>;
		var _id:Array<Float>;
		
		var _interactives:Array<IRenderable>;
		var _interactiveId:UInt;
		var _hitColor:UInt;
		var _projX:Float;
		var _projY:Float;
		
		var _hitRenderable:IRenderable;
		var _hitEntity:Entity;
		var _localHitPosition:Vector3D;
		var _hitUV:Point;
		var _faceIndex:UInt;
		var _subGeometryIndex:UInt;
		
		var _localHitNormal:Vector3D;
		
		var _rayPos:Vector3D;
		var _rayDir:Vector3D;
		var _potentialFound:Bool;
		...
		public function new()
		{
			...
			_id = new Array<Float>();
			_viewportData = new Array<Float>(); // first 2 contain scale, last 2 translation
			_boundOffsetScale = new Array<Float>(); // first 2 contain scale, last 2 translation
		...
		private function drawRenderables(item:RenderableListItem, camera:Camera3D):Void
		{
			...
			while (item!=null) {
				...
				_context.setProgramConstantsFromMatrix(Context3DProgramType.VERTEX, 0, matrix.flashMatrix3D, true);
		...
		private function initObjectProgram3D():Void
		{
			...
			// TODO: Somehow upload a shader program 
		...
		private function initTriangleProgram3D():Void
		{
			...
			// TODO: Somehow sort out shader program upload
		...
		private function getApproximatePosition(camera:Camera3D):Void
		{
			...
			_context.setProgramConstantsFromMatrix(Context3DProgramType.VERTEX, 0, localViewProjection.flashMatrix3D, true);
