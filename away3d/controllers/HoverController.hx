package away3d.controllers;
	...
	class HoverController extends LookAtController
	{
		 ...
		 */
		public function new(targetObject:Entity = null, lookAtObject:ObjectContainer3D = null, panAngle:Float = 0, tiltAngle:Float = 90, distance:Float = 1000, minTiltAngle:Float = -90, maxTiltAngle:Float = 90, ?minPanAngle:Float = null, ?maxPanAngle:Float = null, steps:UInt = 8, yFactor:Float = 2, wrapPanAngle:Bool = false)
		{
