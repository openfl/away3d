package away3d.animators.data;
	...
	class SkeletonPose extends NamedAssetBase implements IAsset
	{
		 ...
		 */
		public var jointPoses:Array<JointPose>;
		
		/**
		 * The total number of joint poses in the skeleton pose.
		 */
		public var numJointPoses(get, null) : UInt;
		public function get_numJointPoses() : UInt
		{
		...
		public function new()
		{
			jointPoses = new Array<JointPose>();
		}
		...
		public function clone():SkeletonPose
		{
			...
			// For loop conversion - 			for (var i:UInt = 0; i < numJointPoses; i++)
			var i:UInt = 0;
