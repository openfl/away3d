package away3d.animators.nodes;
	...
	{
		/** @private */
		arcane static var ROTATIONALVELOCITY_INDEX:UInt = 0;
		
		/** @private */
		/*arcane*/ public var _rotationalVelocity:Vector3D;
		 ...
		 */
		public function new(mode:UInt, rotationalVelocity:Vector3D = null)
		{
