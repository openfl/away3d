package away3d.animators.nodes;
	...
	class ParticleColorNode extends ParticleNodeBase
	{
		...
		/** @private */
		arcane static var DELTA_MULTIPLIER_INDEX:UInt = 1;
		
		/** @private */
		arcane static var START_OFFSET_INDEX:UInt = 2;
		
		/** @private */
		arcane static var DELTA_OFFSET_INDEX:UInt = 3;
		
		/** @private */
		arcane static var CYCLE_INDEX:UInt = 4;
		 ...
		 */
		public function new(mode:UInt, usesMultiplier:Bool = true, usesOffset:Bool = true, usesCycle:Bool = false, usesPhase:Bool = false, startColor:ColorTransform = null, endColor:ColorTransform = null, cycleDuration:Float = 1, cyclePhase:Float = 0)
		{
