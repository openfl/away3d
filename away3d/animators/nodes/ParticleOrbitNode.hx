package away3d.animators.nodes;
	...
	{
		/** @private */
		arcane static var ORBIT_INDEX:UInt = 0;
		
		/** @private */
		arcane static var EULERS_INDEX:UInt = 1;
		
		/** @private */
		/*arcane*/ public var _usesEulers:Bool;
		 ...
		 */
		public function new(mode:UInt, usesEulers:Bool = true, usesCycle:Bool = false, usesPhase:Bool = false, radius:Float = 100, cycleDuration:Float = 1, cyclePhase:Float = 0, eulers:Vector3D = null)
		{
			var len:Int = 3;
			if (usesPhase)
				len++;
