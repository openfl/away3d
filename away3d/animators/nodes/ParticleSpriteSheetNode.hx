package away3d.animators.nodes;
	...
	{
		/** @private */
		arcane static var UV_INDEX_0:UInt = 0;
		
		/** @private */
		arcane static var UV_INDEX_1:UInt = 1;
		
		/** @private */
		/*arcane*/ public var _usesCycle:Bool;
		
		/** @private */
		/*arcane*/ public var _usesPhase:Bool;
		
		/** @private */
		/*arcane*/ public var _totalFrames:Int;
		/** @private */
		/*arcane*/ public var _numColumns:Int;
		/** @private */
		/*arcane*/ public var _numRows:Int;
		/** @private */
		/*arcane*/ public var _cycleDuration:Float;
		/** @private */
		/*arcane*/ public var _cyclePhase:Float;
		 ...
		 */
		public var numColumns(get, null) : Float;
		 ...
		 */
		public var numRows(get, null) : Float;
		 ...
		 */
		public var totalFrames(get, null) : Float;
		 ...
		 */
		public function new(mode:UInt, usesCycle:Bool, usesPhase:Bool, numColumns:Int = 1, numRows:UInt = 1, cycleDuration:Float = 1, cyclePhase:Float = 0, totalFrames:UInt = uint.MAX_VALUE)
		{
			var len:Int;
			if (usesCycle) {
				len = 2;
