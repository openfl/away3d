package away3d.animators.nodes;
	...
	{
		/** @private */
		arcane static var FOLLOW_POSITION_INDEX:UInt = 0;
		
		/** @private */
		arcane static var FOLLOW_ROTATION_INDEX:UInt = 1;
		
		/** @private */
		/*arcane*/ public var _usesPosition:Bool;
		
		/** @private */
		/*arcane*/ public var _usesRotation:Bool;
		
		/** @private */
		/*arcane*/ public var _smooth:Bool;
