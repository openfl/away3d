package away3d.animators.nodes;
	...
	{
		/** @private */
		arcane static var BEZIER_CONTROL_INDEX:Int = 0;
		
		/** @private */
		arcane static var BEZIER_END_INDEX:Int = 1;
		
		/** @private */
		/*arcane*/ public var _controlPoint:Vector3D;
		/** @private */
		/*arcane*/ public var _endPoint:Vector3D;
		 ...
		 */
		public function new(mode:UInt, controlPoint:Vector3D = null, endPoint:Vector3D = null)
		{
