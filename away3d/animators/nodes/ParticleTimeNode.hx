package away3d.animators.nodes;
	...
	{
		/** @private */
		arcane static var TIME_STREAM_INDEX:UInt = 0;
		
		/** @private */
		arcane static var TIME_CONSTANT_INDEX:UInt = 1;
		
		/** @private */
		/*arcane*/ public var _usesDuration:Bool;
		/** @private */
		/*arcane*/ public var _usesDelay:Bool;
		/** @private */
		/*arcane*/ public var _usesLooping:Bool;
