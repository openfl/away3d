...
class ParticleTimeNode extends ParticleNodeBase {
    ...
    override public function getAGALVertexCode(pass:MaterialPassBase, animationRegisterCache:AnimationRegisterCache):String {
        ...
        code += "mul " + animationRegisterCache.scaleAndRotateTarget + ".xyzz," + animationRegisterCache.scaleAndRotateTarget + ".xyzz," + temp + "\n";
        if (_usesDuration) {
            if (_usesLooping) {
                ...
                if (_usesDelay) {
                    ...
                    code += "mul " + animationRegisterCache.scaleAndRotateTarget + ".xyzz," + animationRegisterCache.scaleAndRotateTarget + ".xyzz," + div + "\n";
                }
                ...
                code += "mul " + animationRegisterCache.scaleAndRotateTarget + ".xyzz," + animationRegisterCache.scaleAndRotateTarget + ".xyzz," + sge + "\n";
            }
