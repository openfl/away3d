...
class VertexAnimationSet extends AnimationSetBase implements IAnimationSet {
    ...
    private var _streamIndices:Map<MaterialPassBase, Int>;
    private var _useNormals:Map<MaterialPassBase, Bool>;
    private var _useTangents:Map<MaterialPassBase, Bool>;
    ...
    public function new(numPoses:Int = 2, blendMode:String = "absolute") {
        _streamIndices = new Map<MaterialPassBase, Int>();
        _useNormals = new Map<MaterialPassBase, Bool>();
        _useTangents = new Map<MaterialPassBase, Bool>();
