package away3d.animators.states;
	...
	{
		var _rootPos:Vector3D = new Vector3D();
		var _frames:Array<SkeletonPose>;
		var _skeletonClipNode:SkeletonClipNode;
		var _skeletonPose:SkeletonPose = new SkeletonPose();
		var _skeletonPoseDirty:Bool = true;
		var _currentPose:SkeletonPose;
		var _nextPose:SkeletonPose;
		
		/**
		 * Returns the current skeleton pose frame of animation in the clip based on the internal playhead position.
		 */
		public var currentPose(get, null) : SkeletonPose;
		 ...
		 */
		public var nextPose(get, null) : SkeletonPose;
		...
		private function updateSkeletonPose(skeleton:Skeleton):Void
		{
			...
			if (_skeletonClipNode.totalDuration==null)
				return;
			
			if (_framesDirty)
				updateFrames();
			
			var currentPose:Array<JointPose> = _currentPose.jointPoses;
			var nextPose:Array<JointPose> = _nextPose.jointPoses;
