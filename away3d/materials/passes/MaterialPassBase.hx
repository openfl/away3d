package away3d.materials.passes;
	...
	class MaterialPassBase extends EventDispatcher
	{
		...
		/*arcane*/ public var _program3Ds:Array<Program3D>;
		/*arcane*/ public var _program3Dids:Array<Int>;
		var _context3Ds:Array<Context3D> ;
		...
		var _repeat:Bool;
		var _mipmap:Bool;
		var _depthCompareMode:UInt;
		
		var _blendFactorSource:UInt;
		var _blendFactorDest:UInt;
		
		var _enableBlending:Bool;
		...
		public function new(renderToTexture:Bool = false)
		{
			...
			_program3Ds = new Array<Program3D>();
			_program3Dids = [-1, -1, -1, -1, -1, -1, -1, -1];
			_context3Ds = new Array<Context3D>();
