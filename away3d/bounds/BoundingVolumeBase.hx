package away3d.bounds;
	...
	class BoundingVolumeBase
	{
		var _min:Vector3D;
		var _max:Vector3D;
		var _aabbPoints:Array<Float>;
		var _aabbPointsDirty:Bool;
		var _boundingRenderable:WireframePrimitiveBase;
		 ...
		 */
		public var aabbPoints(get, null) : Array<Float>;
