...
class OBJParser extends ParserBase {
    ...
    private var _objects:Array<ObjectGroup>;
    private var _materialIDs:Array<String>;
    private var _materialLoaded:Array<LoadedMaterial>;
    private var _materialSpecularData:Array<SpecularData>;
    ...
    private var _vertexNormals:Array<Vertex>;
