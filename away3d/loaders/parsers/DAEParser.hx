...
class DAEParser extends ParserBase {
    ...
    private var _parseState:DAEParserState;
    ...
    private function applySkinController(geometry:Geometry, mesh:DAEMesh, skin:DAESkin, skeleton:Skeleton):Void {
        ...
        for (i in 0...geometry.subGeometries.length) {
            ...
            skinned_sub_geom.updateData(sub.vertexData.copy());
    ...
    private function parseLibrary<T>(list:List<Fast>, clas:Class<T>):StringMap<T> {
    ...
    private function processControllerMorph(controller:DAEController, instance:DAEInstanceController):Geometry {
        ...
        for (i in 0...base.subGeometries.length) {
            ...
            vertexData = sub.vertexData.copy();
    ...
    public var effects(get, null):StringMap<DAEEffect>;

    private function get_effects():StringMap<DAEEffect> {
        return _libEffects;
    }

    public var images(get, null):StringMap<DAEImage>;

    private function get_images():StringMap<DAEImage> {
        return _libImages;
    }

    public var materials(get, null):StringMap<DAEMaterial>;

    private function get_materials():StringMap<DAEMaterial> {
