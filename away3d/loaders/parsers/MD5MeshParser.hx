...
class MD5MeshParser extends ParserBase {
    ...
    private var _shaders:Array<String>;

    private var _maxJointCount:Int;
    private var _meshData:Array<MeshData>;
    private var _bindPoses:Array<Matrix3D>;
